import 'dart:async';
import 'package:database_intro/utils/Instagram/constants.dart';
import 'dart:convert';
...
class LoginPresenter {
  ...
  void performLogin(context) {
    assert(_view != null);
    getToken(constants.APP_ID,
        constants.APP_SECRET, context).then((token)
    {
      if (token != null) {
  ...
  Future<Token> getToken(String appId, String appSecret, context) async {
